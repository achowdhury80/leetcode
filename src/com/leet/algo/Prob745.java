...
public class Prob745 {
  ...
  public static void main(String[] args) {
    Prob745 prob745 = null;
    prob745 = new Prob745(new String[]{"apple"});
    System.out.println(prob745.f("a", "e"));
    System.out.println(prob745.f("a", ""));
    System.out.println(prob745.f("", ""));
    prob745 = new Prob745(new String[]{"pop"});
    System.out.println(prob745.f("", ""));
    System.out.println(prob745.f("", "p"));
    //System.out.println(prob745.f("", ""));
  }
