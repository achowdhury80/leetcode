...
public class Problem444 {
	...
	public static void main(String[] args) {
		Problem444 problem = new Problem444();
		/*System.out.println(problem.sequenceReconstruction(new int[] {1, 2, 3}, 
				Arrays.asList(Arrays.asList(1, 2), Arrays.asList(1, 3), 
						Arrays.asList(2, 3))));*/
		System.out.println(problem.sequenceReconstruction(new int[] {4, 1, 5, 2, 6, 3}, 
				Arrays.asList(Arrays.asList(5, 2, 6, 3), 
